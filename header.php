...
<body>
  ...
  <center><span class="ht"><img src="img/ruet.png" width="50px" height="50px"/></span><span class="ht">SNISTOJ</span></center>
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse navbar-menubuilder">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li class="space2" class="dropdown" class="dropdown"><a href="" class="dropdown-toggle"  data-toggle="dropdown">Practice<b class="caret"></b></a>
